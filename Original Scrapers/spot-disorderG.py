...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul  3 09:53:13 2019
...
if args.quiet == 0:
    print('Writing files...')
path = '/home/galmog/Documents/Disorder/SPOT-Disorder-Single/SPOT-Disorder-Single/Output/'

for J,j in enumerate(tqdm.tqdm(base_name,file=tqdmfile)):
    with open(path + j+'-SpotDisorder.csv','w') as f:
        ls = args.vars[J].split(".")
        f.write(ls[0] + ',' + datetime.today().strftime('%Y-%m-%d') + ',' + 'SPOT-Disorder2' + '\n')
